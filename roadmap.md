...
> ⏭️ Фазы 3–4 (рефакторинг/качество P2 и новые возможности) — остаются впереди; ориентир — §3 и §4 ниже.
...
Осталось **опционально** (сознательно отложено в Фазе 2, не входит в P1-минимум):
...
Есть pytest (96 тестов: юнит + mock-интеграционные через pytest-asyncio, `tests/test_integration.py`). 
