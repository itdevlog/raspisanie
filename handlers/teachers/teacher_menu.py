...
async def handle_teacher_subscription(update: Update, context: ContextTypes.DEFAULT_TYPE, callback_data: str):
    await _teacher_handler.handle_subscription_callback(update, context, callback_data)
